...
void xamarin_create_classes () {
	...
	__xamarin_class_map [147].handle = objc_getClass ("__UILongPressGestureRecognizer");
	...
	__xamarin_class_map [150].handle = objc_getClass ("__UIPanGestureRecognizer");
	__xamarin_class_map [151].handle = objc_getClass ("__UIPinchGestureRecognizer");
	__xamarin_class_map [152].handle = objc_getClass ("__UISwipeGestureRecognizer");
	__xamarin_class_map [153].handle = objc_getClass ("__UIScreenEdgePanGestureRecognizer");
